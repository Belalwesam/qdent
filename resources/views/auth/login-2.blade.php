                ...
                @endif
                    ...
                    <form class="form fv-plugins-framework" method="post" id="kt_login_singin_form" novalidate="novalidate" action="{{route('login')}}">
                        ...
                        <div class="pb-5 pb-lg-15">
                            ...
                            <div class="text-muted font-weight-bold font-size-h4">هل انت جديد؟
                        ...
                        <div class="form-group fv-plugins-icon-container">
                            ...
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" value="{{ old('phone') }}" name="phone" autocomplete="off">
                            <div class="fv-plugins-message-container">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group fv-plugins-icon-container" >
                            ...
                            <div class="fv-plugins-message-container">
                                <a href="custom/pages/login/login-4/forgot.html" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">هل نسيت كلمة المرور؟</a>
