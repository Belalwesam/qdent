                            ...
                            <div class="tab-pane show px-7 active" id="kt_user_edit_tab_1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                            ...
                                            <div class="col-9">
                                                <div class="image-input image-input-empty image-input-outline"
                                                    ...
                                                    <label
                                                        ...
                                                        <input type="file" id="profile_avatar" name="img"
                                                            accept=".png, .jpg, .jpeg">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">اسم المستخدم</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid"
                                        ...
                                        <!--begin::Group-->
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> البريد الإلكتروني
                                            </label>
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> كلمة المرور
                                                الجديدة</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid"
                                                    name="password" type="password" placeholder="كلمة المرور الجديدة">
                                            </div>
                                        </div>
                                        <!--end::Group-->
                                        <!--begin::Group-->
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> تأكيد كلمة
                                                المرور</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-7">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-9">
                                                            <button type="submit"
                                                                class="btn btn-light-primary btn-save font-weight-bold">
                                                                حفظ التغييرات</button>
                                                            <a href="#"
                                                                class="btn btn-clean font-weight-bold">إلغاء</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
