    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{ route('employee.update' , $employee->id) }}" class="formAction">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <h6 class="text-dark font-weight-bold mb-10">Employee :</h6>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        <!--begin::Group-->
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Img</label>
                                            <div class="col-9">
                                                <div class="image-input image-input-empty image-input-outline" id="kt_user_edit_avatar" style="background-image: url({{asset('qdent/storage/app/'.$employee->img)}})">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" name="name"  type="text" value="{{$employee->name}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Job Postion</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" name="job_position"  type="text" value="{{$employee->job_position}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Whatsapp</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" name="whatsapp"  type="text" value="{{$employee->whatsapp}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="phone"  class="form-control form-control-lg form-control-solid" value="{{$employee->phone}}" placeholder="Phone">
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Group-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="email" class="form-control form-control-lg form-control-solid" value="{{$employee->email}}" placeholder="Email">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-7">
                                                    <div class="row">
                                                        <div class="col-3"></div>
                                                        <div class="col-9">
                                                            <a href="#" class="btn btn-light-primary btn-update font-weight-bold"> Update </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
