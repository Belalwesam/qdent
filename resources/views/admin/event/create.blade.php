...
@section('content')
    ...
    <form  method="POST" action="{{route('event.store')}}" class="formAction" enctype="multipart/form-data">
        @csrf
        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 my-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <h6 class="text-dark font-weight-bold mb-10">{{__(" Detail Event ")}}</h6>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        <!--begin::Group-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" required name="name" placeholder="Event Name"  type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <textarea type="text" name="description" class="form-control form-control-lg form-control-solid"  placeholder="Event Description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="location"  required class="form-control form-control-lg form-control-solid"  placeholder="Location * ">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="date" name="date"  required class="form-control form-control-lg form-control-solid"  placeholder="Date * ">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-4">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="time" name="from"  required class="form-control form-control-lg form-control-solid"  placeholder="Price * ">
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="time" name="to"  required class="form-control form-control-lg form-control-solid"  placeholder="Price * ">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-7">
                                                    <div class="row">
                                                        <div class="col-3"></div>
                                                        <div class="col-9">
                                                            <button class="btn btn-light-primary btn-save font-weight-bold">{{__("Save")}}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
