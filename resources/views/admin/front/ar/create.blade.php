    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom  gutter-b example example-compact">
                ...
                <form  method="POST" action="{{route('property.update',$ads->id)}}" class="formAction">
                    @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12 my-2">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label class="col-form-label col-3 text-lg-right text-left">{{__("Date and Time * ")}}</label>
                                                        <div class="col-9">
                                                            <div class="input-group input-group-lg input-group-solid">

                                                                <input type="datetime-local" name="date"  required class="form-control form-control-lg form-control-solid"  placeholder="Price * ">
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <br>
                <hr>
                <form  method="POST" action="{{route('image.delte',$ads->id)}}" class="formAction">
                    @csrf
                    <input type="hidden" name="id" value="{{$ads->id}}">
                    @method('Patch')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="gallery">
                                ...
                                @foreach($ads->gallery as $img)

                                    <img height="180" src="{{asset('funny/storage/app/'.$img)}}">
                                    <input type="checkbox" name="{{$img->id}}" value="{{$img->id}}"  >
                                @endforeach
                            </div>
