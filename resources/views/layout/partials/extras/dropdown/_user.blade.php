@if (config('layout', 'extras/user/dropdown/style') == 'light')
    ...
    <div class="d-flex align-items-center p-8 rounded-top">
        ...
        <span class="label label-light-success label-lg font-weight-bold label-inline">3 @lang('lang.message')</span>
    </div>
...
@else
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap p-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('media/misc/bg-1.jpg') }}')">
        ...
        <span class="label label-success label-lg font-weight-bold label-inline">3 @lang('admin.messages')</span>
    </div>
@endif
...
<div class="navi navi-spacer-x-0 pt-5">
    {{-- Item --}}
    <a href="{{route('admin.UserEdit',Auth::user()->id)}}" class="navi-item px-8">
        <div class="navi-link">
            ...
            <div class="navi-text">
                <div class="font-weight-bold">
                    @lang('admin.my_account')
                </div>
                <div class="text-muted">
                    @lang('admin.my_account_sub')
    ...
    {{--            <div class="navi-text">--}}
    {{--                <div class="font-weight-bold">--}}
    {{--                    @lang('admin.my_message')--}}

    {{--                </div>--}}
    {{--                <div class="text-muted">--}}
    {{--                    @lang('admin.my_message_sub')--}}
    {{--                </div>--}}
    {{--            </div>--}}
    {{--        </div>--}}
    {{--    </a>--}}
    ...
    <div class="navi-footer  px-8 py-5">
        <a href="{{ route('logout') }}"  class="btn btn-light-primary font-weight-bold" onclick="event.preventDefault();document.getElementById('frm-logout').submit();" >
            @lang('admin.logout')
        </a>
        <form id="frm-logout" action="{{ route('logout') }}" method="GET" style="display: none;">
            {{ csrf_field() }}
        </form>{{--        <a href="#" target="_blank" class="btn btn-clean font-weight-bold">Upgrade Plan</a>--}}
    </div>
</div>
